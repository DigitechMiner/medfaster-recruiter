    ...
    <div className="flex flex-col h-full">
      ...
      <div className="px-6 py-6 space-y-6 flex-1">
        ...
        <div className="text-center">
          ...
          <p
            className={`text-[40px] font-bold tracking-tight transition-colors ${
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="px-6 py-6 flex-1 flex flex-col gap-6">
        <PaymentElement onLoadError={() => onBack()} />
        ...
        <div className="flex gap-3 mt-auto">
          ...
          >
            {isProcessing
              ? "Processing..."
              : `Pay $ ${amount.toLocaleString("en-CA")}`}
          </button>
        </div>
      </div>
    </div>
    ...
    <div className="min-h-screen bg-[#F9F8F6] flex items-center justify-center px-4 py-10">
      <div className="w-full max-w-4xl">
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden flex flex-col md:flex-row">
          ...
          <div
            className={`md:w-1/2 md:border-r border-gray-100 transition-opacity duration-300 ${
              step === "pay"
