...
function CardActions({
  ...
  switch (colKey) {
      ...
      return (
        <div className="flex gap-1.5 mt-0.5">
          <button
            ...
            className="flex-1 py-2 rounded-xl border border-gray-200 text-xs font-medium text-gray-700 hover:bg-gray-50 disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
          >
    ...
    case 'shortlisted':
      return (
        <div className="flex gap-1.5 mt-0.5">
          <button className="flex-1 py-2 rounded-xl border border-red-300 bg-red-50 text-xs font-medium text-red-500 hover:bg-red-100 transition-colors">Remove</button>
          <button className="flex-1 py-2 rounded-xl border border-gray-200 text-xs font-medium text-gray-700 hover:bg-gray-50 transition-colors">Request Interview</button>
        </div>
      );
    ...
    case 'interviewed':
      return (
        <div className="flex gap-1.5 mt-0.5">
          <button className="flex-1 py-2 rounded-xl border border-red-300 bg-red-50 text-xs font-medium text-red-500 hover:bg-red-100 transition-colors">Reject</button>
          <button
            onClick={() => onAction("hire", appId)}
