...
export const CandidatesBoard = () => {
  ...
  // ── No static data fallback — use live data only ──────────────────────────
  ...
  // Fix 3: specialty is string[] — join before searching
  ...
  // Fix 2: convert numbers to string explicitly
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 flex flex-col gap-4">
        ...
        {/* Fix 1: error.message instead of error directly */}
        {error && (
