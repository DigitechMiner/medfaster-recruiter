...
type CandidateWithExtras = CandidateDetailsResponse & {
  is_hired?: boolean;
  specialty?: string[];
...
const getActionConfig = (candidate: CandidateWithExtras): ActionConfig => {
  ...
  if (candidate.is_currently_available) {
    return {
      showAiBadge: false,
      showShortlist: false,
      primaryLabel: "Schedule A Interview",
  ...
  return {
    showAiBadge: false,
    showShortlist: false,
    primaryLabel: "Invite For a Job",
    primaryVariant: "orangeOutline",
...
export const CandidateHero: React.FC<CandidateHeroProps> = ({
  ...
  const roleTags: string[] = useMemo(() => {
    ...
    const raw: string[] = Array.isArray(rawSpecialty)
      ? rawSpecialty
      : rawSpecialty
      ? [rawSpecialty]
      : skillsArray;
  ...
  const currentCompany =
    candidate.work_experiences?.[0]?.company || "KeRaeva";
  const currentRole =
    candidate.work_experiences?.[0]?.title || "Licensed Practical Nurse";
      ...
      <div className="bg-white border border-gray-200 rounded-2xl overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row gap-5 items-start">
            ...
            <div className="flex-1 min-w-0 flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4">
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-sm font-semibold text-[#F4781B]">
                    Work Eligibility :
                  </span>
        ...
        <div className="px-6 py-4 mt-3 border-t border-gray-100">
          <div className="flex flex-wrap items-center gap-3">
            <span className="text-sm font-semibold text-[#F4781B] whitespace-nowrap">
              Specializations :
            </span>
